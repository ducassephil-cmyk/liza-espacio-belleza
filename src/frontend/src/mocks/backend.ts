    ...
    return [
      {
        id: 0n,
        name: "Nersa",
        role: "Especialista en faciales y masajes",
        bio: "Nersa es la especialista principal en limpiezas faciales de Liza. Combina técnica depurativa con un trato cálido y personalizado.",
        servicesIds: [0n, 1n, 2n, 3n],
        silhouetteVariant: 0n,
      },
      {
        id: 1n,
        name: "Jennifer",
        role: "Terapeuta en masajes",
        bio: "Jennifer se especializa en masajes relajantes y descontracturantes. Su enfoque terapéutico ayuda a liberar tensiones y recuperar el bienestar corporal.",
        servicesIds: [2n, 3n, 4n, 5n],
